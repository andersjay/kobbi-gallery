<div class="container px-8  pt-14 w-full mx-auto pb-10 border-t border-gray-800">
    ...
    <div class="md:grid md:grid-cols-2 md:gap-4 mt-11  content-between">
        <a href="{{$highlight->url}}" class="w-full flex flex-col gap-2">
            <div class="w-full max-w-[600px] h-[300px]">
                <img class="w-full h-full object-cover" src="{{ $highlight->image }}" alt="">
            </div>
        ...
        <div class="flex flex-col gap-4">
            @foreach($noticies as $notice)
                <a href="{{$notice->url}}" class="grid grid-cols-2 gap-2">
                    <div class="w-full">
                    ...
                    <div class="w-full">
                       <div class="w-full h-[143px]">
                            <img class="w-[222px] h-[143px] object-cover" src="{{ $notice->image }}" alt="">
                       </div>
                    </div>
                </a>
            @endforeach
