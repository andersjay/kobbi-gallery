    ...
    <div class="w-full flex flex-col gap-2 md:grid md:grid-cols-[2fr_1fr] md:gap-4 lg:grid-cols-[1fr_1fr] lg:gap-8">
        ...
        <div class="">
            <div class="md:h-auto flex flex-col gap-1">
                ...
                <h4 class="text-md text-gray-500 {{$actualExhibition->is_collective === 1 ? 'uppercase' : '' }}">{{$actualExhibition->is_collective ===  1 ? 'EXPOSIÇÃO COLETIVA' : $pastExhibition->author_name}}</h4>
