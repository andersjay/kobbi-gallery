        ...
        <div class="mb-10">
            ...
            <div class="flex flex-col md:flex-row bg-white py-6">
                ...
                <div class="w-full md:w-2/3">
                    ...
                    <div class="text-gray-700 text-base mb-4 text-[14px] text-justify">{!! $nextEvent->description !!}</div>
            ...
            @foreach($previousEvents as $event)
                <div class="flex flex-col md:flex-row gap-6 items-center bg-white rounded-xl p-5">
                    ...
                    <div class="w-full md:w-3/4 ">
                        ...
                        <div class="text-gray-700 text-base mb-1 text-[14px] text-justify flex-wrap break-words">{!! \Illuminate\Support\Str::limit($event->description, 300) !!}</div>
                        <div class="mt-4">
